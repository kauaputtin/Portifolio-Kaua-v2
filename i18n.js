...
(() => {
  ...
  const en = {
    ...
    /* Muscle Shops detail */
    'Experiência de Kauã como cofundador da Muscle Shops Suplementos, unindo empreendedorismo e tecnologia.': "Kauã's experience as co-founder of Muscle Shops Suplementos, combining entrepreneurship and technology.",
    'Muscle Shops Suplementos | Jornada de Kauã': "Muscle Shops Suplementos | Kauã's Journey",
    'Cofundador | E-commerce, Marketing e Tecnologia': 'Co-founder | E-commerce, Marketing, and Technology',
    'Cofundador': 'Co-founder',
    'E-commerce': 'E-commerce',
    'Marketing': 'Marketing',
    'Empreendedorismo e tecnologia': 'Entrepreneurship and technology',
    'E-commerce, Marketing e Tecnologia': 'E-commerce, Marketing, and Technology',
    'Atuo como cofundador da Muscle Shops Suplementos, contribuindo para a gestão do e-commerce, estratégia comercial, relacionamento com clientes, marketing e presença digital da marca.': 'As co-founder of Muscle Shops Suplementos, I contribute to e-commerce management, commercial strategy, customer relationships, marketing, and the brand’s digital presence.',
    'Atuo como cofundador da Muscle Shops Suplementos, contribuindo diretamente para a gestão do e-commerce, estratégia comercial, relacionamento com clientes, marketing e fortalecimento da presença digital da marca.': 'As co-founder of Muscle Shops Suplementos, I contribute directly to e-commerce management, commercial strategy, customer relationships, marketing, and strengthening the brand’s digital presence.',
    'Empreendedorismo aplicado à tecnologia': 'Entrepreneurship applied to technology',
    'A partir das necessidades reais da operação, desenvolvi a MS Pedidos, um sistema web próprio para o gerenciamento de pedidos, vendas e pagamentos. Essa experiência me permite unir empreendedorismo e tecnologia, aplicando soluções digitais para tornar os processos da empresa mais organizados, seguros e eficientes.': 'Based on the operation’s real needs, I developed MS Pedidos, a custom web system for managing orders, sales, and payments. This experience allows me to combine entrepreneurship and technology, applying digital solutions to make company processes more organized, secure, and efficient.',
    'Tecnologias da MS Pedidos': 'MS Pedidos technologies',
    'Tecnologias utilizadas na MS Pedidos': 'Technologies used in MS Pedidos',
    'Visitar e-commerce': 'Visit e-commerce',
    'Conhecer a MS Pedidos': 'Explore MS Pedidos',
    'Empresa': 'Company',
    'Atuação': 'Focus',
    'Solução desenvolvida': 'Solution developed',
    'Informações da experiência na Muscle Shops Suplementos': 'Muscle Shops Suplementos experience information',
    'MS Pedidos, sistema desenvolvido a partir das necessidades da operação da Muscle Shops.': 'MS Pedidos, a system developed around the operational needs of Muscle Shops.',
    'Banner da Muscle Shops Suplementos com apresentação da marca e produtos': 'Muscle Shops Suplementos banner presenting the brand and products',
    'Banner de apresentação da Muscle Shops Suplementos.': 'Muscle Shops Suplementos presentation banner.',
    'Logo da Muscle Shops Suplementos em fundo preto': 'Muscle Shops Suplementos logo on a black background',
    'Muscle Shops Suplementos — identidade da marca': 'Muscle Shops Suplementos — brand identity',
    'Página inicial do e-commerce Muscle Shops com categorias e banner de produtos': 'Muscle Shops e-commerce homepage with categories and a product banner',
    'E-commerce Muscle Shops — vitrine digital da marca': 'Muscle Shops e-commerce — the brand’s digital storefront',
    'Marca e produtos digitais': 'Brand and digital products',
    'Destaques visuais': 'Visual highlights',
    'Conheça a marca, o e-commerce e o sistema criado para apoiar a operação.': 'Explore the brand, the e-commerce website, and the system built to support operations.',
    'Destaques visuais da Muscle Shops Suplementos e da MS Pedidos': 'Visual highlights from Muscle Shops Suplementos and MS Pedidos',
    'Espaço reservado para o logo e a apresentação da marca Muscle Shops Suplementos': 'Placeholder for the Muscle Shops Suplementos logo and brand presentation',
    'Logo e apresentação da marca.': 'Logo and brand presentation.',
    'Imagem preparada para': 'Image placeholder prepared for',
    'Espaço reservado para uma imagem do e-commerce Muscle Shops': 'Placeholder for a Muscle Shops e-commerce image',
    'Site de divulgação e venda dos produtos.': 'Website used to promote and sell products.',
    'Tela da MS Pedidos com formulário para cadastro de pedidos da Muscle Shops': 'MS Pedidos screen with the Muscle Shops order form',
    'Tela da MS Pedidos, sistema desenvolvido para a operação da Muscle Shops': 'MS Pedidos screen, a system developed for Muscle Shops operations',
    'Tela do sistema MS Pedidos para gerenciamento de pedidos': 'MS Pedidos order management screen',
    'Tela do sistema MS Pedidos para gerenciamento de pedidos, vendas e pagamentos': 'MS Pedidos screen for managing orders, sales, and payments',
    'MS Pedidos — gestão da operação': 'MS Pedidos — operations management',
    'Conhecer minha experiência como cofundador da Muscle Shops Suplementos': 'Explore my experience as co-founder of Muscle Shops Suplementos',
    'Sistema web responsivo': 'Responsive web system',
    'Sistema web responsivo desenvolvido para o gerenciamento de pedidos, vendas e pagamentos da Muscle Shops. Construído com HTML5, CSS3 e JavaScript, possui integração com Supabase, banco de dados PostgreSQL, autenticação de usuários e políticas de segurança RLS. O projeto foi versionado com Git e GitHub.': 'Responsive web system developed to manage Muscle Shops orders, sales, and payments. Built with HTML5, CSS3, and JavaScript, it integrates with Supabase and a PostgreSQL database, with user authentication and RLS security policies. The project was version-controlled with Git and GitHub.',
    'Ver detalhes do projeto MS Pedidos': 'View MS Pedidos project details',
